...
import br.com.pagseguro.emission.events.avro.emission.card.IssuerCardChangedEventCard
...
fun buildRandomCardChangedEventCard(): IssuerCardChangedEventCard =
    IssuerCardChangedEventCard.newBuilder()
        ...
        .setINDEMISSIONPRODUCTCARDTYPE(EmissionProductCardTypeEnum.values().toList().shuffled().first().name)
